...
class Script extends FlxBasic implements IFlxDestroyable {
	...
	public static function getDefaultVariables(?script:Script):Map<String, Dynamic> {
		return [
			...
			"HLUIComponent"			=> funkin.hl.ui.HLUIComponent,
			"HLUIBox"				=> funkin.hl.ui.HLUIBox,
			"HLUILabel"				=> funkin.hl.ui.HLUILabel,
			"HLUITab"				=> funkin.hl.ui.HLUITab,
			"HLUITabBox"			=> funkin.hl.ui.HLUITabBox,
			"HLUIButton"			=> funkin.hl.ui.HLUIButton,
			"HLUIWindow"			=> funkin.hl.ui.HLUIWindow,
			"HLUICheckbox"			=> funkin.hl.ui.HLUICheckbox,
			"HLUINumberStepper"		=> funkin.hl.ui.HLUINumberStepper,
			"HLUITable"				=> funkin.hl.ui.HLUITable,
			"Layout"				=> funkin.hl.ui.HLUIBox.Layout
		];
	}
